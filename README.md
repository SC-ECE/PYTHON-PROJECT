...
``$ cd <cloned-folder>`` 
``$ git remote add upstream https://github.com/SC-ECE/PYTHON-PROJECT.git ``
******
...
<table>
	<tr>
		<td>
			<a href="https://github.com/SC-ECE/PYTHON-PROJECT/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=SC-ECE/PYTHON-PROJECT" />
</a>
		</td>
	</tr>
</table>
